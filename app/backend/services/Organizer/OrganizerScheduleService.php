...
final class OrganizerScheduleService
{
    ...
    private const MATCH_STATUSES = ['CHO_DOI_DOI', 'CHO_XEP_LICH', 'DA_XEP_LICH', 'CHUA_DIEN_RA', 'SAP_DIEN_RA', 'DANG_DIEN_RA', 'TAM_DUNG', 'DA_KET_THUC', 'DA_HUY'];
    private const EDITABLE_MATCH_STATUSES = ['CHO_DOI_DOI', 'CHO_XEP_LICH', 'DA_XEP_LICH', 'CHUA_DIEN_RA', 'SAP_DIEN_RA'];
    ...
    public function summary(int $tournamentId, int $accountId): array
    {
        ...
        return [
            ...
            'schedule' => [
                ...
                'referees' => $this->schedules->activeReferees(),

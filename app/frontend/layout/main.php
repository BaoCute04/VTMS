...
$navByRole = [
    ...
    'VAN_DONG_VIEN' => [
        ...
        'Cá nhân' => [
            ...
            ['icon' => 'TK', 'label' => 'Thống kê', 'href' => '/van-dong-vien/thong-ke-ca-nhan'],
    ...
    'KHAN_GIA' => [
        'Tổng quan' => [
            ['icon' => 'TC', 'label' => 'Trang chủ', 'href' => '/dashboard'],
            ['icon' => 'DB', 'label' => 'Đội bóng', 'href' => '/khan-gia/doi-bong'],
            ['icon' => 'LT', 'label' => 'Lịch thi đấu', 'href' => '/khan-gia/lich-thi-dau'],
            ['icon' => 'KQ', 'label' => 'Kết quả', 'href' => '/khan-gia/ket-qua'],
            ['icon' => 'XH', 'label' => 'Bảng xếp hạng', 'href' => '/khan-gia/bang-xep-hang'],
        ],
    ],
];
